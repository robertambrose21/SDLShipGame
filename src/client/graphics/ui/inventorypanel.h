...
private:
    ...
    std::function<void(Item* item, Equippable<GearStats>::Slot slot)> onEquipClicked;
    std::function<void(Item* item, Equippable<GearStats>::Slot slot)> onUnequipClicked;
...
public:
    ...
    void addOnEquipCallback(std::function<void(Item* item, Equippable<GearStats>::Slot slot)>&& callback);
    void addOnUnequipCallback(std::function<void(Item* item, Equippable<GearStats>::Slot slot)>&& callback);
